...
🎓 Edu[![Notion](https://img.shields.io/badge/Notion-Portfolio-000000?style=flat-square&logo=notion&logoColor=white)](https://kyj-01-p.notion.site/3106ea0bf552807fbdd2c3dbbdcaadaf)
[![Email](https://img.shields.io/badge/lliana1045@naver.com-EA4335?style=flat-square&logo=gmail&logoColor=white)](mailto:lliana1045@naver.com)
[![GitHub](https://img.shields.io/badge/GitHub-lliana906-181717?style=flat-square&logo=github&logoColor=white)](https://github.com/lliana906)

👋 안녕하세요! 저는 **반도체 품질 검증 엔지니어**를 목표로 하는 김유정입니다. 🔬  
전북대학교에서 생태조경디자인을 전공하며 **iAB융합전공(IoT · AI · Big Data)** 을 복수전공했습니다.
...
|--------|-------|---------|
| 2024 | 객체 인식 기반 택배 보안 시스템 | STM32, 카메라 모듈 활용 무인 보안 |
| 2024 | 초음파 센서 자율주행 RC CAR | L298N 모터드라이버, STM32 |
| 2024 | 안전 엘리베이터 CallTalk Eli | 온도 센서 기반 안전 모니터링, STM32 |
| 2024 | 탁상용 선풍기 | STM32 PWM 제어 |
| 2024 | 만보기 | FPGA RTL 설계 (Basys3) |
| 2024 | UART IP → MATRIX 구현 | SOC 프로젝트 (Basys3) |
| 2024 | AI와 Pong 경쟁 | FPGA 기반 게임 구현 |
| 2024 | AI를 활용한 음악 만들기 | Python, AI |
| 2024 | 대챗헤시대의 창책 양상 분석 | 데이터 분석 |
| 2024 | AI 여행앱 | AI 활용 앱 |
...
- Jeonbuk Univ. Ecological Landscape Design (본전공)
- Jeonbuk Univ. iAB Convergence Major — IoT · AI · Big Data (복수전공)
